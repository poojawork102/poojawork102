...
- 📄 **Research Paper (ICSSC Conference):** Author / Presenter focusing on **Computational Neuroscience & EEG Biomarker Analysis** (Theta, Alpha, Beta band signals).
- 🏆 **Startup School:** Completed the **Google Startup School** program.
- 🚀 **Hackathons:** Google Solution Challenge & AI Student Competition participant.
